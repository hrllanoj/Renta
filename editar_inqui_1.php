...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info_inquilino SET fecha_de_fecha_hasta = '$fecha_de_fecha_hasta', nombre = '$nombre', documento_ = '$documento_', celular = '$celular', cobro_debe = '$cobro_debe' WHERE id_info_inquilino = '$id'";
...
$sql = "SELECT * FROM info_inquilino WHERE id_info_inquilino = '$id'";
...
<img src=".jpg" alt="">
<div class="container">
    <form action="editar_inqui_1.php" method="post">
        ...
        <div class="input-container">
            <a href="info_inqui_1.php">REGRESAR</a>
