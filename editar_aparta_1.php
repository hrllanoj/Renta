...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info_apartamento SET direccion = '$direccion', alcobas = '$alcobas', baños = '$baños', patio_terraza = '$patio_terraza', amoblado = '$amoblado' WHERE id_info_apartamento = '$id'";
...
$sql = "SELECT * FROM info_apartamento WHERE id_info_apartamento = '$id'";
...
<img src=".jpg" alt="">
<div class="container">
    <form action="editar_aparta_1.php" method="post">
        ...
        <div class="input-container">
            <a href="info_aparta_1.php">REGRESAR</a>
