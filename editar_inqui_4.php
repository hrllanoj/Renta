...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info_inquilino_4 SET fecha_de_fecha_hasta = '$fecha_de_fecha_hasta', nombre = '$nombre', documento_ = '$documento_', celular = '$celular', cobro_debe = '$cobro_debe' WHERE id_info_inquilino = '$id'";
...
$sql = "SELECT * FROM info_inquilino_4 WHERE id_info_inquilino = '$id'";
...
<body>
<div class="container">
    <form action="editar_inqui_4.php" method="post">
        ...
        <div class="input-container">
            <a href="info_inqui_4.php">REGRESAR</a>
