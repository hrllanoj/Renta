...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info_apartamento_4 SET direccion = '$direccion', alcobas = '$alcobas', baños = '$baños', patio_terraza = '$patio_terraza', amoblado = '$amoblado' WHERE id_info_apartamento = '$id'";
    $query = mysqli_query($conexion, $sql);

    if ($query) {
        header("Location: info_aparta_1.php");
        exit;
    } else {
...
$sql = "SELECT * FROM info_apartamento_4 WHERE id_info_apartamento = '$id'";
...
<body>
<div class="container">
    <form action="editar_aparta_4.php" method="post">
        ...
        <div class="input-container">
            <a href="info_aparta_4.php">REGRESAR</a>
