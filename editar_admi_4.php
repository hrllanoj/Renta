...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info_administracion_4 SET fecha_de__fecha_hasta = '$fecha_de__fecha_hasta', servicios = '$servicios', daños_mantenimiento = '$daños_mantenimiento', revision = '$revision', predial = '$predial' WHERE id_info_administracion = '$id'";
...
$sql = "SELECT * FROM info_administracion_4 WHERE id_info_administracion = '$id'";
...
<body>
<div class="container">
    <form action="editar_admi_4.php" method="post">
        ...
        <div class="input-container">
            <a href="info_admi_4.php">REGRESAR</a>
