...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info_apartamento_3 SET direccion = '$direccion', alcobas = '$alcobas', baños = '$baños', patio_terraza = '$patio_terraza', amoblado = '$amoblado' WHERE id_info_apartamento = '$id'";
...
$sql = "SELECT * FROM info_apartamento_3 WHERE id_info_apartamento = '$id'";
...
<body>
<div class="container">
    <form action="editar_aparta_3.php" method="post">
        ...
        <div class="input-container">
            <a href="info_aparta_3.php">REGRESAR</a>
