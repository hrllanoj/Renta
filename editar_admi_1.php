...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE info_administracion SET fecha_de__fecha_hasta = '$fecha_de__fecha_hasta', servicios = '$servicios', daños_mantenimiento = '$daños_mantenimiento', revision = '$revision', predial = '$predial' WHERE id_info_administracion = '$id'";
    $query = mysqli_query($conexion, $sql);

    if ($query) {
        header("Location: info_admi_1.php");
        exit;
    } else {
...
$sql = "SELECT * FROM info_administracion WHERE id_info_administracion = '$id'";
...
<img src=".jpg" alt="">
<div class="container">
    <form action="editar_admi_1.php" method="post">
        ...
        <div class="input-container">
            <a href="info_admi_1.php">REGRESAR</a>
