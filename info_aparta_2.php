...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO info_apartamento_2 (direccion, alcobas, baños, patio_terraza, amoblado, id_usuarios) 
...
$query = "SELECT * FROM info_apartamento_2 WHERE id_usuarios = $id_";
...
<body>
<form action="info_aparta_2.php" method="post">
    <h1>INFORMACION 2</h1>
    <table>
        <tr>
            <th>DIRECCION</th>
    ...
    <table>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td><a href="editar_aparta_2.php?id=' . $row['id_info_apartamento'] . '"class="nombre">EDITAR</a></td>';
            echo '<td><a href="dele_aparta_2.php?id=' . $row['id_info_apartamento'] . '"class="nombre">ELIMINAR</a></td>';
            echo "</tr>";
        } 
        ?>
    </table>
