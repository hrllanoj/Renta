...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO info_inquilino_4 (fecha_de_fecha_hasta, nombre, documento_, celular, cobro_debe, id_usuarios) 
...
$query = "SELECT * FROM info_inquilino_4 WHERE id_usuarios = $id_";
...
<body>
<form action="info_inqui_4.php" method="post">
    <h1>INQUILINO 4</h1>
    <table>
        <tr>
    ...
    <table>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td><a href="editar_inqui_4.php?id=' . $row['id_info_inquilino'] . '"class="nombre">EDITAR</a></td>';
            echo '<td><a href="dele_inqui_4.php?id=' . $row['id_info_inquilino'] . '"class="nombre">ELIMINAR</a></td>';
            echo "</tr>";
        } 
        ?>
    </table>
